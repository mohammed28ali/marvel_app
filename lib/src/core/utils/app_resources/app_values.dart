...
class AppEdgeInsetsMargins {static const EdgeInsetsGeometry customCategoryMargin = EdgeInsets.fromLTRB(24, 24, 24, 12);
}

class AppDurations {
  static const Duration milliSeconds800 = Duration(milliseconds: 800);
}
